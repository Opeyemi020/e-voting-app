package e_voting_app.utils;

import at.favre.lib.crypto.bcrypt.BCrypt;
import e_voting_app.exceptions.IncorrectPasswordException;

public class AppUtils {
    public static final int ONE = 1;
    public static final int EIGTHEEN = 18;
    public static final String PARTY_REGISTERED_SUCCESSFULLY = "Party registered successfully";
    public static final String PARTY_DOESNT_EXIST = "Party does not exist";
